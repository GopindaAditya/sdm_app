    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-surface-light dark:bg-surface-dark border-r border-border-light dark:border-border-dark flex flex-col hidden md:flex shrink-0">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a class="flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium transition-colors {{ request()->is('data-pegawai*') ? 'bg-primary/10 text-primary' : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}" href="{{ route('data_pegawai') }}">
